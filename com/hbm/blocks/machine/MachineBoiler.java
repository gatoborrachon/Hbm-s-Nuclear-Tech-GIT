...
public class MachineBoiler extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		if (this == ModBlocks.machine_boiler_off || this == ModBlocks.machine_boiler_on) {
			this.iconFront = iconRegister.registerIcon(
					RefStrings.MODID + (this.isActive ? ":machine_boiler_front_lit" : ":machine_boiler_front"));
		...
		if (this == ModBlocks.machine_boiler_electric_off || this == ModBlocks.machine_boiler_electric_on) {
			this.iconFront = iconRegister.registerIcon(RefStrings.MODID
					+ (this.isActive ? ":machine_boiler_electric_front_lit" : ":machine_boiler_electric_front"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
		...
		if (world.isRemote) {
			...
			if (te instanceof TileEntityMachineBoiler) {
				...
				if (entity != null) {
					FMLNetworkHandler.openGui(player, MainRegistry.instance, ModBlocks.guiID_machine_boiler, world, x,
							y, z);
				}
			}
			...
			if (te instanceof TileEntityMachineBoilerElectric) {
				...
				if (entity != null) {
					FMLNetworkHandler.openGui(player, MainRegistry.instance, ModBlocks.guiID_machine_boiler_electric,
							world, x, y, z);
				}
			}
			return true;
