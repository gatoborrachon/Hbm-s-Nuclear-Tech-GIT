...
public class ItemForgeFluidIdentifier extends Item {
	
	IIcon overlayIcon;

    public ItemForgeFluidIdentifier()
    {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean bool)
	{
    	...
    	list.add("   " + I18n.format(FluidRegistry.getFluid(stack.getItemDamage()).getUnlocalizedName()));
	}
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int i, float f1, float f2, float f3)
    {
		...
		if(te != null && te instanceof TileEntityFFFluidDuct) {
			...
			duct.setType(FluidRegistry.getFluid(stack.getItemDamage()));
		}
		return false;
    }
