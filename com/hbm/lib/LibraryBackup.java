...
public class LibraryBackup {
	...
	public static void ffgeua(int x, int y, int z, boolean newTact, ISource that, World worldObj) {
		...
		if(tileentity instanceof IConductor)
		{
			...
			{
				if(LibraryBackup.checkUnionList(((TileEntityCable)tileentity).uoteab, that))
				{
			...
			{
				if(LibraryBackup.checkUnionList(((TileEntityWireCoated)tileentity).uoteab, that))
				{
			...
			if(tileentity instanceof TileEntityCableSwitch)
			{
				if(tileentity.getBlockMetadata() == 1) {
					if(LibraryBackup.checkUnionList(((TileEntityCableSwitch)tileentity).uoteab, that))
					{
			...
			{
				if(LibraryBackup.checkUnionList(((TileEntityPylonRedWire)tileentity).uoteab, that))
				{
	...
	public static void transmitFluid(int x, int y, int z, boolean newTact, IFluidSource that, World worldObj, FluidType type) {
		...
		if(tileentity instanceof IFluidDuct)
		{
			...
			{
				if(LibraryBackup.checkUnionListForFluids(((TileEntityFluidDuct)tileentity).uoteab, that))
				{
			...
			{
				if(LibraryBackup.checkUnionListForFluids(((TileEntityGasDuct)tileentity).uoteab, that))
				{
			...
			{
				if(LibraryBackup.checkUnionListForFluids(((TileEntityOilDuct)tileentity).uoteab, that))
				{
			...
			{
				if(LibraryBackup.checkUnionListForFluids(((TileEntityGasDuctSolid)tileentity).uoteab, that))
				{
			...
			{
				if(LibraryBackup.checkUnionListForFluids(((TileEntityOilDuctSolid)tileentity).uoteab, that))
				{
