...
public class TileEntityCompactLauncher extends TileEntity implements ISidedInventory, IConsumer, IFluidHandler, ITankPacketAcceptor {
	...
	public void updateEntity() {
		...
		if (!worldObj.isRemote) {
			...
			if(this.inputValidForTank(1, 2))
				if(FFUtils.fillFromFluidContainer(slots, tanks[2], 2, 3))
					needsUpdate = true;
