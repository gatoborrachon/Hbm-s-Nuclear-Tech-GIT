...
public class GUIMachineBoiler extends GuiInfoContainer {
	...
	public static ResourceLocation texture = new ResourceLocation(
			RefStrings.MODID + ":textures/gui/gui_boiler.png");
	private TileEntityMachineBoiler diFurnace;

	public GUIMachineBoiler(InventoryPlayer invPlayer,
			TileEntityMachineBoiler tedf) {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.drawCustomInfoStat(
				...
				mouseY,
				new String[] { String
						.valueOf((int) ((double) diFurnace.heat / 100D))
						+ "°C" });
		this.drawCustomInfoStat(
				mouseX,
				mouseY,
				...
				mouseX,
				mouseY,
				new String[] { String.valueOf((int) (Math
						.ceil((double) diFurnace.burnTime / 20D))) + "s" });

		String[] text = new String[] { "Heat produced:", "  0.5°C/t",
				"  or 10°C/s", "Heat consumed:", "  0.15°C/t",
				"  or 3.0°C/s (base)", "  0.25°C/t",
				"  or 5.0°C/t (once boiling point is reached)", "  0.4°C/t",
				"  or 8.0°C/t (for every subsequent multiple of boiling point)" };
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft - 16, guiTop + 36, 16,
				16, guiLeft - 8, guiTop + 36 + 16, text);

		String[] text1 = new String[] { "Boiling rate:",
				"  Base rate * amount of full multiples",
				"  of boiling points reached" };
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft - 16, guiTop + 36 + 16,
				16, 16, guiLeft - 8, guiTop + 36 + 16, text1);
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		String name = this.diFurnace.hasCustomInventoryName() ? this.diFurnace
				.getInventoryName() : I18n.format(this.diFurnace
				.getInventoryName());
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_,
		...
		if (diFurnace.isInvalid()
				&& diFurnace.getWorldObj().getTileEntity(diFurnace.xCoord,
						diFurnace.yCoord, diFurnace.zCoord) instanceof TileEntityMachineBoiler)
			diFurnace = (TileEntityMachineBoiler) diFurnace.getWorldObj()
					.getTileEntity(diFurnace.xCoord, diFurnace.yCoord,
							diFurnace.zCoord);
		...
		FFUtils.drawLiquid(diFurnace.tanks[0], guiLeft, guiTop, this.zLevel, 16, 52, 62, 69);

		FFUtils.drawLiquid(diFurnace.tanks[1], guiLeft, guiTop, this.zLevel, 16, 52, 134, 69);
